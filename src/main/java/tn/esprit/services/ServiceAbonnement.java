...
public class ServiceAbonnement implements Iabonnement <Abonnement> {
    ...
    public void create(Abonnement obj) throws SQLException {
        ...
        pstmt.setString(3, obj.getDate_Souscription());
        pstmt.setString(4, obj.getDate_Expiration());
    ...
    public List<Abonnement> getAll() throws SQLException {
        ...
        while (rs.next()) {
            ...
            a.setDate_Souscription(rs.getString("date_Souscription"));
            a.setDate_Expiration(rs.getString("date_Expiration"));
